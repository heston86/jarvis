// ==================== CORE TYPES ====================
// The foundation of the Jarvis framework

// ==================== MEMORY ====================
export type MemoryKind =
  | "profile"      // User preferences, habits, info
...
export type OrchestratorAction =
  ...
  | "ask_approval"      // Ask user for approval
...
export interface OrchestratorResponse {
  ...
  target?: string;                    // Tool or agent ID
  args?: Record<string, any>;         // Arguments for tool/agent
  userFacingText: string;             // What to tell the user
  internalReasoning?: string;         // Why this decision was made
  memoryWriteCandidates?: MemoryWriteCandidate[];
